...
sealed trait AtlassianHost {
  ...
  /**
    * Authentication type to use when communicating with the host product.
    *
    * @return Authentication type in use, either JWT or OAuth2
    */
  def authenticationType: AuthenticationType

  /**
    * Tenant identifier for use with OAuth 2.0 client credentials flow.
    *
    * @return Cloud id tenant identifier, if it is enabled for this installation.
    */
  def cloudId: Option[String]
